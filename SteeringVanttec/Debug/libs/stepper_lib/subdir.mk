...
libs/stepper_lib/%.o libs/stepper_lib/%.su: ../libs/stepper_lib/%.c libs/stepper_lib/subdir.mk
...
clean-libs-2f-stepper_lib:
	-$(RM) ./libs/stepper_lib/encoder.d ./libs/stepper_lib/encoder.o ./libs/stepper_lib/encoder.su ./libs/stepper_lib/stepper.d ./libs/stepper_lib/stepper.o ./libs/stepper_lib/stepper.su ./libs/stepper_lib/stepper_tasks.d ./libs/stepper_lib/stepper_tasks.o ./libs/stepper_lib/stepper_tasks.su
