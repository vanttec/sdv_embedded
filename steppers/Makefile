##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [4.5.0-B34] date: [Tue Nov 05 22:40:56 CST 2024]
##########################################################################################################################
...
-Ilibs/vanttec_CANLib/platform_specific/vanttec_canlib_stm \
-Ilibs/vanttec_CANLib/src/Vanttec_CANLib \
-Ilibs/stepper_lib \


CXX_INCLUDES = 
# -Ilibs/vanttec_CANLib/src/Vanttec_CANLib \
# -Ilibs/vanttec_CANLib/src/Vanttec_CANLib/ByteOrder \
# -Ilibs/vanttec_CANLib/src/Vanttec_CANLib/Utils
...
# C++ specific flags
CXXFLAGS = $(CFLAGS) $(CXX_INCLUDES) -fno-rtti -fno-exceptions -fno-threadsafe-statics
